% !TeX document-id = {5e861f06-9164-4817-838b-6bf08c3182c0}
...
\begin{frame}{Why \LaTeX{}?}
  \begin{itemize}
    ...
    \item You may be required to use it
    \begin{itemize}
      \item Some journals, conferences, publishers expect it
    \end{itemize}
  \end{itemize}
\end{frame}
...
or a recent \href{http://www.mozilla.org/en-US/firefox/new/}{Mozilla Firefox}.
\end{center}
\vskip 2ex
...
\end{itemize}
\item That's amazing!
\item Next, we'll see how to use \LaTeX{} to write structured documents
...
\begin{itemize}
\item So far, we learned about commands and environments for typesetting text
and mathematics.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{References: Caveats}
  \begin{itemize}
    \item To be able to calculate references, \LaTeX{} sometimes
      needs to be run several times.
    
    \item Overleaf manages that for you, but if you're using
      \LaTeX{} locally you should be aware of that.
    
    \item There is a script \texttt{latexmk} that manages
      that for you, it's normally included with \LaTeX{}.
  \end{itemize}
\end{frame}
...
paper generator.}}
\begin{center}
\fbox{\href{structure-exercise-solution.pdf}{%
...
\begin{enumerate}
\item You have the following example files on your computer:

\quad 
\begin{tabular}{ll}
%\fbox{\href{\fileuri/gerbil.jpg}{Click to download example image}}
%\fbox{\href{\fileuri/bib-exercise.bib}{Click to download example bib file}}
Image file: & gerbil.jpg\\[0.2em]
Bib file: & bib-exercise.bib
\end{tabular}
...
\begin{center}
\fbox{\href{recap-exercise-solution.pdf}{%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\protect\bftt{beamer} package}
...
\item To generate an outline, use the \cmdbs{tableofcontents} command. Here's an abridged
...
\begin{minipage}{0.5\linewidth}
  ...
  % trim: l b r t
  \includegraphics[width=\textwidth]{beamer-toc.pdf}
  \end{minipage}
\end{itemize}
\end{frame}
...
\end{exampletwouptiny}
\vskip 1ex
\item See \url{https://en.wikibooks.org/wiki/LaTeX/Colors}
...
%\item You can try the several themes
\begin{center}
	\fbox{\href{\wlnewdoc{beamer-theme.tex}}{%
			Click to open the file with themes in \wllogo{}}}
\end{center}
\end{itemize}
\begin{minipage}{0.55\linewidth}
\inputminted[fontsize=\scriptsize,frame=single,resetmargins]{latex}%
...
\vskip 2ex
\item There are many more clever ways of making animations in \bftt{beamer}; see
also the \cmdbs{only}, \cmdbs{alt}, and \cmdbs{uncover} commands.
\end{itemize}
{\small
  More info on \texttt{beamer}:
  \begin{itemize}
    \item \href{https://en.wikibooks.org/wiki/LaTeX/Presentations}{LaTeX/Presentations on Wikibooks}
    \item \href{http://tug.ctan.org/macros/latex/contrib/beamer/doc/beameruserguide.pdf}{Beamer package manual}
  \end{itemize}
}
...
\end{center}
\vskip 2ex
\item Upload the following image to \wllogo{} via the
files menu.
\begin{center}
gettysburg\_graph.png
\end{center}
\vskip 2ex
\item Add \LaTeX{} commands to the text to make it look like this one:
\begin{center}
\fbox{\href{beamer-exercise-solution.pdf}{%
Click to open the model document}}
\end{center}
\end{enumerate}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\protect\tikzname{} examples}
...
\begin{frame}[fragile]{\insertsection: Exercise}
Draw this in \tikzname:\footnote{Based on \url{https://xkcd.com/1022}}
\begin{figure}
\input{tikz-exercise-solution}
\end{figure}
\end{frame}

%\begin{frame}{More complex drawings}
%With the \bftt{overpic} package one can import a pdf file and write text on selected locations from the imported image.
%\begin{exampletwouptiny}
...
\begin{frame}[fragile]{\insertsubsection}
\begin{itemize}
\item The \cmdbs{tableofcontents} command also works outside \texttt{beamer}
to generate a table of contents from the \cmdbs{section} commands.

\item You can define your own commands as shortcuts:
\begin{exampletwouptiny}
\newcommand{\rperf}{%
  \rho_{\text{perf}}}
\begin{equation*}
...
\newcommand{\textblue}[1]{%
  \textcolor{blue}{#1}}
This is \textblue{blue} now.
\end{exampletwouptiny}
\end{itemize}

{\scriptsize
\keystrokebftt{\%} at the end of a line suppresses a line break where
  \LaTeX{} is sensitive to whitespace.
}
\end{frame}
...
\item \bftt{chemfig}, \bftt{mhchem}: chemical formulae and graphics
\item \bftt{gchords}, \bftt{guitar}: guitar chords and tabulature
\item \bftt{cwpuzzle}: crossword puzzles
\item \bftt{exam}: problem sheets' generator (creating pdf with or without the solutions)
\item \bftt{geometry}: can be helpful to set up the page layout
\end{itemize}
...
\end{itemize}
\item You'll also want a text editor with \LaTeX{} support.
See \href{http://en.wikipedia.org/wiki/Comparison_of_TeX_editors}{Comparison of TeX editors} for a list of (many) options.
...
\item \href{https://tex.stackexchange.com/}{\TeX{} Stack Exchange} --- ask
